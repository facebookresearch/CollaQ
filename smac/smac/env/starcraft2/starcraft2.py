...
#                 _map = maps.get(self.map_name[np.random.choice(len(self.map_name)-1)])
#             else:
#                 _map = maps.get(self.map_name[np.random.choice(len(self.map_name))])
...
#         # Set the very important person
#         if test_mode:
#             self.vip = self.n_agents-1
#         else:
#             self.vip = np.random.choice(self.n_agents-1)
...
#                 else:
#                     reward = 1
#                 unit = self.get_unit_by_id(self.vip)
#                 if unit.health > 0:
#                     reward += self.vip_reward
#                     info["vip_alive"] = True
...
#         nf_al = 4 + self.shield_bits_ally + self.unit_type_bits + 1
...
#                 ally_state[al_id, -1] = self.vip == al_id
...
#         return self.n_agents - 1, nf_al + 1
...
#     def init_units(self, test_mode=False):
